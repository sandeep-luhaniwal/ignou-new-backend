...
const seedDatabase = async () => {
    try {
        ...
        await Promise.all([
            ...
            Query_1.default.deleteMany({}),
            Notice_1.default.deleteMany({}),
            commentModel_1.default.deleteMany({}),
            PromoCode_1.default.deleteMany({})
        ]);
        ...
        const student4 = await User_1.default.create({
            name: "Neha Gupta",
        ...
        const catBachelor = await Category_1.default.create({ name: "bachelor degree" });
        const catMaster = await Category_1.default.create({ name: "master degree" });
        const catDiploma = await Category_1.default.create({ name: "diploma programmes" });
        const catCertificate = await Category_1.default.create({ name: "certificate programmes" });
        // Subcategories under Bachelor Degree
        const subBCA = await Category_1.default.create({ name: "bca", parent: catBachelor._id });
        const subBCOMG = await Category_1.default.create({ name: "bcomg", parent: catBachelor._id });
        const subBAG = await Category_1.default.create({ name: "bag", parent: catBachelor._id });
        const subBSCG = await Category_1.default.create({ name: "bscg", parent: catBachelor._id });
        // Subcategories under Master Degree
        const subMCA = await Category_1.default.create({ name: "mca", parent: catMaster._id });
        const subMBA = await Category_1.default.create({ name: "mba", parent: catMaster._id });
        const subMCOM = await Category_1.default.create({ name: "mcom", parent: catMaster._id });
        const subMAENG = await Category_1.default.create({ name: "meg", parent: catMaster._id });
        // Subcategories under Diploma
        const subPGDCA = await Category_1.default.create({ name: "pgdca", parent: catDiploma._id });
        const subDECE = await Category_1.default.create({ name: "dece", parent: catDiploma._id });
